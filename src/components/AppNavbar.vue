<template>
  <nav
    class="bg-gray-100 border-gray-200 py-2.5 dark:bg-[#1a2030] rounded-2xl mx-2 mb-2 isolate min-[375px]:mx-3 min-[375px]:mb-3 min-[450px]:mx-4 min-[450px]:mb-4 sticky top-2 min-[375px]:top-3 min-[450px]:top-4 z-50">
    <div
