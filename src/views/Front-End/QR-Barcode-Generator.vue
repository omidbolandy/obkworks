<template>
  ...
  <div class="min-h-screen text-gray-100 px-4 py-8 sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto space-y-10 mt-7">
      ...
      <div class="bg-gray-900 rounded-2xl p-8 sm:p-12 space-y-10">
        <!-- QR CODE SECTION -->
        <section class="bg-gray-800 rounded-2xl p-5 sm:p-6 shadow-lg space-y-4">
          ...
          <div class="flex flex-col sm:flex-row gap-3">
            <input
              ...
              class="flex-1 bg-gray-900 border border-gray-700 rounded-lg px-4 py-2.5 text-gray-100 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
            />
            <button
              @click="generateQR"
            ...
            <button
              @click="resetQR"
              class="shrink-0 bg-gray-700 hover:bg-gray-600 active:bg-gray-800 text-gray-100 font-medium px-5 py-2.5 rounded-lg transition"
            >
          ...
          <div
            class="flex items-center justify-between flex-wrap gap-2 text-sm text-gray-400"
          >
            ...
            <div class="flex items-center gap-2">
              ...
              <select
                v-model="qrSize"
                class="bg-gray-900 border border-gray-700 rounded-lg px-2 py-1 text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                <option value="small">
          ...
          <div
            class="w-full min-h-[180px] sm:min-h-[220px] bg-gray-900 border border-dashed border-gray-700 rounded-xl flex items-center justify-center p-4"
          >
            <canvas
              v-show="qrGenerated"
              ref="qrCanvasRef"
            ...
            ></canvas>
            <span v-if="!qrGenerated" class="text-gray-600 text-sm">
              {{ i18n.global.t("qrBarcode.emptyResult") }}
            </span>
          </div>

          <div v-if="qrGenerated" class="flex flex-wrap gap-3">
            <button
              @click="downloadQR('png')"
              class="bg-gray-700 hover:bg-gray-600 text-gray-100 text-sm font-medium px-4 py-2 rounded-lg transition"
            >
        ...
        <section class="bg-gray-800 rounded-2xl p-5 sm:p-6 shadow-lg space-y-4">
          ...
          <div
            class="w-full min-h-[140px] sm:min-h-[160px] bg-gray-900 border border-dashed border-gray-700 rounded-xl flex items-center justify-center p-4 overflow-x-auto"
          >
            <canvas
              ...
              class="max-w-full h-auto"
            ></canvas>
            <span v-if="!barcodeGenerated" class="text-gray-600 text-sm">
              {{ i18n.global.t("qrBarcode.emptyResult") }}
            </span>
          </div>

          <div v-if="barcodeGenerated" class="flex flex-wrap gap-3">
            <button
...
async function generateQR() {
  ...
  try {
    await QRCode.toCanvas(qrCanvasRef.value, value, {
      ...
      margin: 1,
      color: { dark: "#111827", light: "#f3f4f6" },
    });
