    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            class="overflow-hidden rounded-3xl bg-slate-50 p-4 dark:bg-slate-950"
          >
            <svg
            ...
            <div
              class="mt-3 flex flex-wrap gap-x-4 gap-y-1.5 text-xs text-gray-600 dark:text-gray-300"
            >
