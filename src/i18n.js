...
const messages = {
    ...
    en: {
        ...
        nav: {
            ...
            searchCompactPlaceholder: 'Search...',
        ...
        search: {
            ...
            inputLabel: 'Search the portfolio',
            articles: 'Articles',
            projects: 'Projects',
            viewAll: 'View all results for "{query}"',
            noResults: 'No articles or projects matched your search.',
            noQuery: 'Type something to search the articles and projects.',
    ...
    fa: {
        ...
        nav: {
            ...
            projects: 'پروژه‌ها',
            search: 'جست‌وجو',
            searchPlaceholder: 'جست‌وجوی مقالات و پروژه‌ها...',
            searchCompactPlaceholder: 'جست‌وجو...',
        ...
        search: {
            title: 'نتایج جست‌وجو',
            inputLabel: 'جست‌وجو در پورتفولیو',
            articles: 'مقالات',
            projects: 'پروژه‌ها',
            viewAll: 'مشاهده همه نتایج برای «{query}»',
            noResults: 'مقاله یا پروژه‌ای مطابق جست‌وجوی شما پیدا نشد.',
            noQuery: 'برای جست‌وجو در مقالات و پروژه‌ها چیزی بنویسید.',
            openResult: 'مشاهده نتیجه',
        },
